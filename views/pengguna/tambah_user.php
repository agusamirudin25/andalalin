        ...
        <form action="index.php?p=tambah_user" method="post" class="form-horizontal">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              <select name="level" class="form-control">
                ...
                <option value="bagian pengiriman">Bagian Pengiriman</option>
                <option value="bagian penjualan">Bagian Penjualan</option>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              ...
              <a href="index.php?p=user" class="btn btn-sm btn-danger btn-custom"><span class="fa fa-angle-double-left"></span> Kembali</a>
            </div>
          </div>
        </form>
      </div>
