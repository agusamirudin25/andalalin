      ...
      <div class="box-body">
        ...
        <form action="" method="post" class="form-horizontal">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              <select class="form-control" name="level" id="">
                ...
                <option value="bagian penjualan" <?php if ($user->level == 'bagian penjualan') {echo "selected";}?>>Bagian Penjualan</option>
                <option value="bagian pengiriman" <?php if ($user->level == 'bagian pengiriman') {echo "selected";}?>>Bagian Pengiriman</option>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              <button type="submit" name="simpan" class="btn btn-sm btn-primary btn-custom"><span class="fa fa-save"> Simpan</button>
              <button type="reset" class="btn btn-sm btn-secondary btn-custom"><span class="fa fa-refresh"></span> Batal</button>
              <a href="index.php?p=user" class="btn btn-sm btn-danger btn-custom"><span class="fa fa-angle-double-left"> Kembali</a>
            </div>
          </div>
        </form>
      </div>
