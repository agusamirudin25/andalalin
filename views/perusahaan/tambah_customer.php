...
if (isset($_POST['simpan'])) {
  ...
  if (empty($nama_customer)) {
    $error['nama_customer'] = 'Customer Harus Diisi !<br>';
  }
  if (empty($no_tlp)) {
  ...
  {
    $customer->simpan_customer($kode_customer, $nama_customer, $no_tlp, $alamat); //simpan data
  }
}
?>
<?php
$kode = $customer->kode_terakhir();
?>
      ...
      <div class="box-body">
        ...
        <form action="" method="post" class="form-horizontal">
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" name="kode_customer" value="<?php echo $kode ?>" readonly>
            </div>
          </div>
          <div class="form-group row">
