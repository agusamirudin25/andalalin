                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group col-sm-4">
                                                                ...
                                                                <input type="text" class="form-control form_input_cap form_input text-sm" id="no_reg" value="<?= $data_perusahaan['no_registrasi'] ?>" name="no_reg" style="margin-top: 8px;" placeholder="no registrasi" disabled>
                                                            </div>
                                                            <div class="input-group col-sm-4">
                                                                <div class="input-group-append" style="margin-top: 8px;">
                                                                    <button type="button" class="btn btn-primary"><i class="fa fa-info-circle"></i></button>
                                                                </div>
                                                                <input type="number" class="form-control form_input_cap form_input text-sm" id="no_nib" name="no_nib" value="<?= $data_perusahaan['no_nib'] ?>" style="margin-top: 8px;" placeholder="NIB" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group col-sm-4">
                                                                ...
                                                                <input type="text" class="form-control form_input form_input_cap text-sm" id="nama_perusahaan" name="nama_perusahaan" value="<?= $data_perusahaan['nama_perusahaan'] ?>" placeholder="Nama Perusahaan" style="margin-top: 8px;" disabled>
                                                            </div>
                                                            <div class="input-group col-sm-4">
                                                                <div class="input-group-append" style="margin-top: 8px;">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group col-sm-4">
                                                                ...
                                                                <input type="date" class="form-control form_input form_input_cap text-sm" id="tanggal_bpn" name="tanggal_bpn" style="margin-top: 8px;" disabled value="<?= $data_perusahaan['tanggal_bpn'] ?>">
                                                            </div>
                                                            <div class="input-group col-sm-4">
                                                                <div class="input-group-append" style="margin-top: 8px;">
                                                                    <button type="button" class="btn btn-primary"><i class="fa fa-credit-card"></i></button>
                                                                </div>
                                                                <input type="number" class="form-control  form_input text-sm" id="no_akte" name="no_akte" style="margin-top: 8px;" placeholder="no akte" disabled value="<?= $data_perusahaan['no_akte'] ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group col-sm-4">
                                                                ...
                                                                <input type="date" class="form-control form_input form_input_cap text-sm" id="tanggal_akte" name="tanggal_akte" style="margin-top: 8px;" disabled value="<?= $data_perusahaan['tanggal_akte'] ?>">
                                                            </div>
                                                            <div class="input-group col-sm-4">
                                                                <div class="input-group-append" style="margin-top: 8px;">
                                                                    <button type="button" class="btn btn-primary"><i class="fa fa-credit-card"></i></button>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group col-sm-4">
                                                                ...
                                                                <input type="number" class="form-control form_input form_input_cap text-sm" id="no_npwp_perusahaan" name="no_npwp_perusahaan" placeholder="no npwp" style="margin-top: 8px;" disabled value="<?= $data_perusahaan['no_npwp_perusahaan'] ?>">
                                                            </div>
                                                            <div class="input-group col-sm-4">
                                                                <div class="input-group-append" style="margin-top: 8px;">
                                                                    <button type="button" class="btn btn-primary"><i class="fa fa-credit-card"></i></button>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group col-sm-4">
                                                                ...
                                                                <input type="text" class="form-control form_input form_input_cap text-sm" id="nama_npwp_perusahaan" name="nama_npwp_perusahaan" placeholder="Nama NPWP Perusahaan" style="margin-top: 8px;" disabled value="<?= $data_perusahaan['nama_npwp_perusahaan'] ?>">
                                                            </div>
                                                            <div class="input-group col-sm-4">
                                                                <div class="input-group-append" style="margin-top: 8px;">
                                                                    <button type="button" class="btn btn-primary"><i class="fa fa-credit-card"></i></button>
                                                                </div>
                                                                <input type="text" class="form-control form_input form_input_cap text-sm" id="alamat_npwp_perusahaan" name="alamat_npwp_perusahaan" placeholder="Alamat NPWP Perusahaan" style="margin-top: 8px;" disabled value="<?= $data_perusahaan['alamat_npwp_perusahaan'] ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group col-sm-4">
                                                                ...
                                                                <input type="text" class="form-control form_input form_input_cap text-sm" id="luas_lahan_bpn" name="luas_lahan_bpn" placeholder="Luas Lahan BPN" style="margin-top: 8px;" disabled value="<?= $data_perusahaan['luas_lahan_bpn'] ?>">
                                                            </div>
                                                            <div class="input-group col-sm-4">
                                                                <div class="input-group-append" style="margin-top: 8px;">
                                                                    <button type="button" class="btn btn-primary"><i class="fa fa-credit-card"></i></button>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group col-sm-4">
                                                                ...
                                                                <input type="number" class="form-control form_input form_input_cap text-sm" id="no_alih_fungsi" name="no_alih_fungsi" placeholder="No Alih Fungsi" style="margin-top: 8px;" disabled value="<?= $data_perusahaan['no_alih_fungsi'] ?>">
                                                            </div>
                                                            <div class="input-group col-sm-4">
                                                                <div class="input-group-append" style="margin-top: 8px;">
                                                                    <button type="button" class="btn btn-primary"><i class="fa fa-credit-card"></i></button>
                                                                </div>
                                                                <input type="date" class="form-control form_input form_input_cap text-sm" id="tanggal_alih_fungsi" name="tanggal_alih_fungsi" style="margin-top: 8px;" disabled value="<?= $data_perusahaan['tanggal_alih_fungsi'] ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group col-sm-4">
                                                                ...
                                                                <input type="text" class="form-control form_input form_input_cap text-sm" id="perihal_alih_fungsi" name="perihal_alih_fungsi" placeholder="Perihal Alih Fungsi" style="margin-top: 8px;" disabled value="<?= $data_perusahaan['perihal_alih_fungsi'] ?>">
                                                            </div>
                                                            <div class="input-group col-sm-4">
                                                                <div class="input-group-append" style="margin-top: 8px;">
                                                                    <button type="button" class="btn btn-primary"><i class="fa fa-credit-card"></i></button>
                                                                </div>
                                                                <input type="text" class="form-control form_input form_input_cap text-sm" id="no_izin_lokasi" name="no_izin_lokasi" placeholder="No izin lokasi" style="margin-top: 8px;" disabled value="<?= $data_perusahaan['no_izin_lokasi'] ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group col-sm-4">
                                                                ...
                                                                <input type="date" class="form-control form_input form_input_cap text-sm" id="tanggal_izin_lokasi" name="tanggal_izin_lokasi" style="margin-top: 8px;" disabled value="<?= $data_perusahaan['tanggal_izin_lokasi'] ?>">
                                                            </div>
                                                            <div class="input-group col-sm-4">
                                                                <div class="input-group-append" style="margin-top: 8px;">
                                                                    <button type="button" class="btn btn-primary"><i class="fa fa-credit-card"></i></button>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group col-sm-4">
                                                                ...
                                                                <input type="number" class="form-control form_input form_input_cap text-sm" id="jumlah_pembangunan" name="jumlah_pembangunan" placeholder="Jumlah Pembangunan" style="margin-top: 8px;" disabled value="<?= $data_perusahaan['jumlah_pembangunan'] ?>">
                                                            </div>
                                                            <div class="input-group col-sm-4">
                                                                <div class="input-group-append" style="margin-top: 8px;">
                                                                    <button type="button" class="btn btn-primary"><i class="fa fa-credit-card"></i></button>
                                                                </div>
                                                                <input type="number" class="form-control form_input form_input_cap text-sm" id="jumlah_ruang_terbangun" name="jumlah_ruang_terbangun" placeholder="Jumlah Ruang Terbangun" style="margin-top: 8px;" disabled value="<?= $data_perusahaan['jumlah_ruang_terbangun'] ?>">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group col-sm-4 ">
                                                                ...
                                                                <input type="text" class="form-control form_input form_input_cap text-sm" id="jumlah_pembangunan" name="jumlah_pembangunan" style="margin-top: 8px;" disabled value="<?= $status; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
