                          ...
                          <div class="form-group">
                            <div class="input-group">
                              ...
                              <div class="input-group col-sm-4">
                                ...
                                <input type="text" class="form-control form_input_cap form_input text-sm" id="no_reg" value="<?php echo $data['no_registrasi']; ?>" name="no_reg" style="margin-top: 8px;">
                              </div>
                              <div class="input-group col-sm-4">
                                <div class="input-group-append" style="margin-top: 8px;">
                                  <button type="button" class="btn btn-primary"><i class="fa fa-info-circle"></i></button>
                                </div>
                                <input type="text" class="form-control form_input_cap form_input text-sm" id="no_nib" value="<?php echo $data['no_nib']; ?>" name="no_nib" style="margin-top: 8px;">
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="form-group">
                            <div class="input-group">
                              ...
                              <div class="input-group col-sm-4">
                                ...
                                <a href="berkas/<?php echo $data['akte_perusahaan']; ?>" style="margin-top: 14px; margin-left: 5px;" target="_blank"><?php echo $data['akte_perusahaan']; ?></a>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="form-group">
                            <div class="input-group">
                              ...
                              <div class="input-group col-sm-4">
                                ...
                                <a href="berkas/<?php echo $data['npwp_perusahaan']; ?>" style="margin-top: 14px; margin-left: 5px;" target="_blank"><?php echo $data['npwp_perusahaan']; ?></a>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="form-group">
                            <div class="input-group">
                              ...
                              <div class="input-group col-sm-4">
                                ...
                                <a href="berkas/<?php echo $data['surat_bpn']; ?>" style="margin-top: 14px; margin-left: 5px;" target="_blank"><?php echo $data['surat_bpn']; ?></a>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="form-group">
                            <div class="input-group">
                              ...
                              <div class="input-group col-sm-4">
                                ...
                                <a href="berkas/<?php echo $data['kriteria_pembangunan']; ?>" style="margin-top: 14px; margin-left: 5px;" target="_blank"><?php echo $data['kriteria_pembangunan']; ?></a>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <div class="input-group ">
                            ...
                            <div class="input-group col-sm-2">
                              <a id="back_home" href="?p=verifikasi" role="tab" aria-controls="custom-tabs-three-home" aria-selected="false" type="button" class="btn btn-warning btn-block" style="margin-top: 8px;">Kembali</a>
                            </div>
                            <div class="input-group col-sm-2">
                              <a style="margin-top: 10px;">
                                <button class=" btn btn-primary btn-block" title="verif" onclick="verif_data('<?= $data['no_registrasi'] ?>')" type="button" <?= ($data['status'] == 1) ? 'disabled' : null ?>>verifikasi</span></button>
                              </a>
                            </div>
                          </div>
                        </div>
